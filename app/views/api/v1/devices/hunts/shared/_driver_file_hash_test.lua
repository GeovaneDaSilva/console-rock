...
function find_driver_file_hash(test_id, search_str)
...
function find_driver_file_hashes(test_id, search_strs)
  ...
  for i, search_str in ipairs(split_search_strs) do
    local test_result = find_driver_file_hash(test_id, search_str)
